...
class Company_Delete_list extends React.Component {
  constructor(props) {
    super();
      ...
      <div className="animate__animated animate__fadeIn  ">
        <div className="Grid1_Container">
          ...
          <div class="Grid1_Main">
            <div className="big_title">기술자료</div>
...
export default Company_Delete_list;
    ...
    return (
      <tr>
        ...
        <td className="Database_title">
          <Link
            to={{
              pathname: `/Company_Tech/Company_Delete/`,
              state: {
