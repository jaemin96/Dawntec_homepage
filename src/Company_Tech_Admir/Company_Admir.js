...
class Company_Admir extends React.Component {
  constructor(props) {
    super();
  ...
  Postitem = async () => {
    Axios.post("https://www.dawnth.co.kr:443/api/Tech_insert", {
      id: "dawntec",
      Password: "dw1357",
  ...
  Cancel_item = async () => {
    ...
    Axios.post("https://www.dawnth.co.kr:443/api/Tech_cancel", {
