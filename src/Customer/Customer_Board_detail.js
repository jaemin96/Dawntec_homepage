...
class Customer_Board_Detail extends React.Component {
  constructor(props) {
    super();

    this.state = {
      global_id: "dawntec",
      global_Password: "dw1357",
  ...
  Postitem = async () => {
    //let server_local_host='http://localhost:8000/api/Board_insert';
    let server_local_host = "https://www.dawnth.co.kr:443/api/Board_insert";
    ...
    if (this.state.Customer_Name === "") {
      ...
      this.props.history.push("/Customer/Customer_Board_list");
    }
...
export default Customer_Board_Detail;
