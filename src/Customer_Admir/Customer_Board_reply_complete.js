...
class Customer_Board_reply_complete extends React.Component {
  constructor(props) {
    super();
  ...
  componentDidMount() {
    ...
    let GetItem = async () => {
      Axios.post(
        "https://www.dawnth.co.kr:443/api/Customer_Board_admir_list", //'http://localhost:8000/api/Customer_Board_admir_list',
        { reply: "답변완료" }
      )
        .then((response) => {
...
export default Customer_Board_reply_complete;
