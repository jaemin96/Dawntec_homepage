...
class Customer_Board_Reply extends React.Component {
  constructor(props) {
    super();
  ...
  Updateitem = async () => {
    Axios.post(
      "https://www.dawnth.co.kr:443/api/Board_reply_update", //'https://172.30.1.48:8000/api/Board_reply_update',
      {
...
export default Customer_Board_Reply;
